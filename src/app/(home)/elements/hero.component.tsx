...
export default async function Hero() {
  ...
  return (
    <section className="md:mt-8 bg-hero-accent md:rounded-2xl flex overflow-hidden h-fit max-md:flex-col">
      <div className="md:max-w-hero-info-block-desk py-8 px-8 md:p-12 md:pr-0 box-border flex flex-col gap-11">
      ...
      <div className="flex w-full justify-center h-67.5 md:h-fit relative md:hidden lg:flex">
        <Image
          ...
          width={280}
          height={580}
          className="absolute top-0 md:top-20 special-shadow max-md:w-hero-img-phone-w max-md:h-hero-img-phone-h"
        />
      </div>
    </section>
  );
